...
public class nnnn
    ...
    private void initComponents() {
        ...
        ResourceMap resourceMap = ((LivefacenewApp) Application.getInstance(LivefacenewApp.class)).getContext().getResourceMap(LivefacenewAboutBox.class);
        setTitle(resourceMap.getString("title", new Object[0]));
        setModal(true);
        setName("aboutBox");
        setResizable(false);

        ActionMap actionMap = ((LivefacenewApp) Application.getInstance(LivefacenewApp.class)).getContext().getActionMap(LivefacenewAboutBox.class, this);
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addComponent(appTitleLabel, GroupLayout.Alignment.LEADING).addComponent(appDescLabel, GroupLayout.Alignment.LEADING, -1, 266, 32767).addComponent(this.closeButton)).addContainerGap()));
